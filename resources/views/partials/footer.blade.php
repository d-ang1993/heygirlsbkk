    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-column footer-customer">
                <h3 class="footer-title">{{ $customer_title }}</h3>
                <div class="footer-phone">{{ $customer_phone }}</div>
                <div class="footer-hours">
                    @foreach(explode("\n", $customer_hours) as $line)
                        @if(trim($line))
                            <div>{{ trim($line) }}</div>
                        @endif
                    @endforeach
            ...
            <div class="footer-column footer-company">
                <h3 class="footer-brand">{{ $company_brand }}</h3>
                <div class="footer-company-info">
                    @foreach(explode("\n", $company_info) as $line)
                        @if(trim($line))
                            <div>{{ trim($line) }}</div>
                        @endif
                    @endforeach
            ...
            <div class="footer-column footer-social">
                @if(!empty($tiktok_url) || !empty($instagram_url) || !empty($shopee_url) || !empty($line_url))
                    <div class="footer-social-grid">
                        @if(!empty($tiktok_url))
                            <a href="{{ $tiktok_url }}" target="_blank" class="footer-social-link footer-social-tiktok">
                        ...
                        @if(!empty($instagram_url))
                            <a href="{{ $instagram_url }}" target="_blank" class="footer-social-link footer-social-instagram">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        @if(!empty($shopee_url))
                            <a href="{{ $shopee_url }}" target="_blank" class="footer-social-link footer-social-shopee">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        @if(!empty($line_url))
                            <a href="{{ $line_url }}" target="_blank" class="footer-social-link footer-social-line">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
