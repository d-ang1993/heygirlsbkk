                ...
                @if ($_product && $_product->exists() && $cart_item['quantity'] > 0)
                  <div class="cart-item-heygirlsbkk">
                    <div class="cart-item-image">
                      <img src="{{ wp_get_attachment_image_url($_product->get_image_id(), 'woocommerce_thumbnail') }}" 
                    ...
                    <div class="cart-item-details">
                      <div class="cart-item-info">
                        ...
                        @if($variation_data)
                          <div class="cart-item-variation">{!! $variation_data !!}</div>
                        @endif
                      ...
                      <div class="cart-item-controls">
                        <div class="quantity-controls">
                          <button type="button" class="quantity-btn minus" data-cart-item-key="{{ $cart_item_key }}">-</button>
                          <input type="number" 
                          ...
                          <button type="button" class="quantity-btn plus" data-cart-item-key="{{ $cart_item_key }}">+</button>
                        </div>
