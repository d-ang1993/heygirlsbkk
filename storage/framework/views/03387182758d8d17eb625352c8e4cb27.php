            ...
            <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:items-center lg:gap-x-8">
              ...
              <div class="quick-view-image-container sm:col-span-4 lg:col-span-5">
                <?php if(!empty($image_ids)): ?>
                  <img src="<?php echo e(wp_get_attachment_image_url($image_ids[0], 'woocommerce_single')); ?>" 
                       alt="<?php echo e($product->get_name()); ?>" 
                       class="quick-view-main-image aspect-[2/3] w-full rounded-lg bg-gray-100 object-cover" />
                <?php else: ?>
                  <img src="<?php echo e(wc_placeholder_img_src('woocommerce_single')); ?>" 
                       alt="<?php echo e($product->get_name()); ?>" 
                       class="quick-view-main-image aspect-[2/3] w-full rounded-lg bg-gray-100 object-cover" />
                <?php endif; ?>
              </div>
              ...
              <div class="sm:col-span-8 lg:col-span-7">
                <h2 class="text-xl font-medium text-gray-900 sm:pr-12"><?php echo e($product->get_name()); ?></h2>
                  ...
                  <div class="mt-4">
                    ...
                    <div class="flex items-center">
                      ...
                      <div class="ml-4 hidden lg:flex lg:items-center">
                        ...
                        <a href="<?php echo e($product->get_permalink()); ?>#reviews" class="ml-4 text-sm font-medium quick-view-link">
                          See all <?php echo e($review_count); ?> <?php echo e($review_count === 1 ? 'review' : 'reviews'); ?>
                ...
                <section aria-labelledby="options-heading" class="mt-8">
                  ...
                  <form class="quick-view-form" method="post" action="<?php echo e(wc_get_cart_url()); ?>" enctype="multipart/form-data" data-product_id="<?php echo e($product_id); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if($is_variable): ?>
                          ...
                          <?php $__currentLoopData = $color_variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color_key => $variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                              <input type="radio" 
                                     ...
                                     value="<?php echo e($color_key); ?>" 
                                     id="quick-view-color-<?php echo e($color_key); ?>"
                                     aria-label="<?php echo e($color_name); ?>"
                                     ...
                                     <?php echo e(!$color_has_stock ? 'disabled' : ''); ?> />
                            </div>
                      ...
                      <fieldset aria-label="Choose a size" class="quick-view-size-fieldset">
                        <div class="flex items-center justify-between">
                          ...
                          <a href="<?php echo e($product->get_permalink()); ?>" class="text-sm font-medium quick-view-link">Size guide</a>
                        </div>
                        <div class="quick-view-size-buttons">
                          ...
                          <?php $__currentLoopData = $sorted_sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <label aria-label="<?php echo e($size_name); ?>" class="quick-view-size-label">
                              <input type="radio" 
                                     name="<?php echo e($size_attr_name); ?>" 
                                     value="<?php echo e($size); ?>" 
                                     id="quick-view-size-<?php echo e($size); ?>"
                                     class="quick-view-size-input" />
                              <span><?php echo e($size_name); ?></span>
                            </label>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                      </fieldset>
                      ...
                      <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr_name => $attr_values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <?php if(!$should_skip): ?>
                          <input type="hidden" name="attribute_<?php echo e($attr_name); ?>" value="" id="quick-view-attr-<?php echo e($attr_name); ?>">
                        <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>

                    <button type="submit" class="quick-view-add-to-cart" <?php echo e($is_variable ? 'disabled' : ''); ?>>
                      Add to bag
                    </button>

                    <p class="absolute left-4 top-4 text-center sm:static sm:mt-8">
                      <a href="<?php echo e($product->get_permalink()); ?>" class="font-medium quick-view-link">View full details</a>
                    </p>
                  </form>
                </section>
              </div>
...
<?php /**PATH /Users/dang/Local Sites/heygirlsbkk/app/public/wp-content/themes/heygirlsbkk/resources/views/components/product-quick-view.blade.php ENDPATH**/ ?>