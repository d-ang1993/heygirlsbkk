...
<section class="hero relative overflow-hidden" style="--hero-height: <?php echo e($height); ?>;">
  ...
  <?php else: ?>
    ...
    <?php if(!empty($bgUrl) && $bgUrl !== ''): ?>
      <div class="hero__bg" 
           style="background-image: url('<?php echo e(esc_url($bgUrl)); ?>'); 
                  background-attachment: <?php echo e(esc_attr($bgAttachment)); ?>; 
                  background-color: <?php echo e(esc_attr($bgColor)); ?>; 
                  background-position: <?php echo e(esc_attr($bgPosition)); ?>;
                  --hero-bg-position-mobile: <?php echo e(esc_attr($bgPositionMobile)); ?>;"></div>
    <?php else: ?>
  ...
  <div class="container">
    <div class="hero__grid hero__grid--column-<?php echo e($gridColumn); ?>">
      <div class="hero__grid-left hero__grid--vertical-<?php echo e($gridVertical); ?> hero__grid--horizontal-<?php echo e($gridHorizontal); ?>">
        <?php if($gridColumn === 'left'): ?>
          <div class="hero__inner hero__inner--grid">
            ...
            <?php endif; ?>
            <?php if($ctaText): ?>
              <a href="<?php echo e($ctaUrl); ?>" class="btn btn-primary hero__cta" style="<?php echo e($ctaFontStyle); ?>; font-size: <?php echo e($ctaFontSize); ?>; font-weight: <?php echo e($ctaFontWeight); ?>; background-color: <?php echo e($ctaColor); ?>;"><?php echo $ctaText; ?></a>
            <?php endif; ?>
          </div>
        <?php endif; ?>
      </div>
      <div class="hero__grid-right hero__grid--vertical-<?php echo e($gridVertical); ?> hero__grid--horizontal-<?php echo e($gridHorizontal); ?>">
        <?php if($gridColumn === 'right'): ?>
          <div class="hero__inner hero__inner--grid">
            <?php
              // Process heading font
              $headingFont = str_replace(['Noto Serif Display Italic', 'Noto Serif Display Condensed'], 'Noto Serif Display', $headingFontFamily);
